...
public class UpgradeKernelPackageTest extends UpgradeKernelPackage {
	...
	public void testDoUpgrade() throws Exception {
		...
		doUpgrade();
		_checkUpgrade(
			"PREFIX_" + _OLD_CLASS_NAME, "ClassName_", "value", _OLD_CLASS_NAME,
			_NEW_CLASS_NAME, true);
		_checkUpgrade(
			_OLD_CLASS_NAME, "Counter", "name", _OLD_CLASS_NAME,
			_NEW_CLASS_NAME, true);
		_checkUpgrade(
			StringBundler.concat("PREFIX_", _OLD_CLASS_NAME, "_POSTFIX"),
			"Lock_", "className", _OLD_CLASS_NAME, _NEW_CLASS_NAME, true);
		_checkUpgrade(
			StringBundler.concat("PREFIX_", _OLD_CLASS_NAME, "_POSTFIX"),
			"UserNotificationEvent", "payload", _OLD_CLASS_NAME,
			_NEW_CLASS_NAME, true);

		_checkUpgrade(
			"PREFIX_" + _OLD_RESOURCE_NAME, "ResourceAction", "name",
			_OLD_RESOURCE_NAME, _NEW_RESOURCE_NAME, true);
		_checkUpgrade(
			_OLD_RESOURCE_NAME + "_POSTFIX", "ResourceBlock", "name",
			_OLD_RESOURCE_NAME, _NEW_RESOURCE_NAME, false);
		_checkUpgrade(
			StringBundler.concat("PREFIX_", _OLD_RESOURCE_NAME, "_POSTFIX"),
			"ResourcePermission", "name", _OLD_RESOURCE_NAME,
			_NEW_RESOURCE_NAME, false);
	}
	...
	public void testUpgradeWithoutMatchData() throws Exception {
		Assert.assertNull(
			_fetchValue(
				"ListType", "type_", _OLD_CLASS_NAME, WildcardMode.TRAILING,
				false));
		upgradeTable(
			"ListType", "type_", getClassNames(), WildcardMode.TRAILING);
		Assert.assertNull(
			_fetchValue(
				"ListType", "type_", _NEW_CLASS_NAME, WildcardMode.TRAILING,
				false));
	}
