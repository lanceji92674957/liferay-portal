 ...
 * @author Raymond Augé
 */
@Component(configurationPolicy = org.osgi.service.component.annotations.ConfigurationPolicy.IGNORE,immediate = true, service = SynchronousConfigurationListener.class)
