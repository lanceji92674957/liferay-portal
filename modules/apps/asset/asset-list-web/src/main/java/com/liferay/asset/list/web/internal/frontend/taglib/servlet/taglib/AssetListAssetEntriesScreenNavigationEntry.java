...
public class AssetListAssetEntriesScreenNavigationEntry
	extends BaseAssetListScreenNavigationEntry {

	@Override
	public String getCategoryKey() {
		return AssetListFormConstants.ENTRY_KEY_ASSET_ENTRIES;
	}
	...
	public String getJspPath() {
		return "/asset_list/asset_entries.jsp";
	}

	@Override
	public String getLabel(Locale locale) {
		return LanguageUtil.get(locale, "asset-entries");
	}
