...
package com.liferay.asset.list.internal.exportimport.xstream.configurator;
...
public class AssetListXStreamConfigurator implements XStreamConfigurator {
	...
	protected void activate() {
		_xStreamAliases = new XStreamAlias[] {
			new XStreamAlias(AssetListEntryImpl.class, "AssetListEntry")
		};
	}
