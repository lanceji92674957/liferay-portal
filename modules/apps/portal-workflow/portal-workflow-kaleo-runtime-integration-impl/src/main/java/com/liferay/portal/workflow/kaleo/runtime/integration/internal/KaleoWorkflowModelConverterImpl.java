 ...
 * @author Shuyang Zhou
 */
@Component(configurationPolicy = org.osgi.service.component.annotations.ConfigurationPolicy.IGNORE,immediate = true, service = KaleoWorkflowModelConverter.class)
