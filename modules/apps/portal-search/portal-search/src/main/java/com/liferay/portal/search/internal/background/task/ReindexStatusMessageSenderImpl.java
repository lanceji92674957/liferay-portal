 ...
 * @author Andrew Betts
 */
@Component(configurationPolicy = org.osgi.service.component.annotations.ConfigurationPolicy.IGNORE,immediate = true, service = ReindexStatusMessageSender.class)
